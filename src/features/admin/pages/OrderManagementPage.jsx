...
import { CircleCheck, Clock3, DollarSign, FileText } from "lucide-react";
            ...
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <div className="w-8 h-8 bg-yellow-100 dark:bg-yellow-900/20 rounded-lg flex items-center justify-center">
                  <Clock3 className="w-5 h-5 text-yellow-600 dark:text-yellow-400" />
                </div>
              </div>
              <div className="ml-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900 dark:text-white">5,234</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-semibold text-gray-900 dark:text-white">$234,567</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                {[
                  { id: 1, orderNumber: "ORD-2024-001", customer: "John Doe", date: "2024-01-15", total: 149.99, status: "pending", payment: "pending" },
                  { id: 2, orderNumber: "ORD-2024-002", customer: "Jane Smith", date: "2024-01-14", total: 89.99, status: "processing", payment: "paid" },
                  { id: 3, orderNumber: "ORD-2024-003", customer: "Bob Johnson", date: "2024-01-13", total: 299.99, status: "shipped", payment: "paid" },
                  { id: 4, orderNumber: "ORD-2024-004", customer: "Alice Brown", date: "2024-01-12", total: 199.99, status: "delivered", payment: "paid" },
                  { id: 5, orderNumber: "ORD-2024-005", customer: "Charlie Wilson", date: "2024-01-11", total: 79.99, status: "cancelled", payment: "refunded" }
                ].map((order) => (
